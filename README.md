...
- 🛠️ **Thực hành:** Sử dụng Postman test REST API, truy vấn SQL kiểm tra dữ liệu, quản lý mã nguồn bằng Git.
...
- [x] **Version Control:** Sử dụng Git cơ bản (clone, push, pull, commit) để quản lý mã nguồn.
